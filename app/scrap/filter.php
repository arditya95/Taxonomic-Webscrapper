    ...
    while ($row = mysqli_fetch_array($hasil))
    {
        ...
        elseif ($row['th']=="Phylum"){
          ...
          echo "[Phylum] Jumlah ROW : ". $row_coun . "<br>";
            ...
            // $use_id_kingdom=1;
            $idsql_cek="SELECT * FROM tb_kingdom WHERE nama_kingdom='tidak diketahui';";
            $get_use_id_kingdom=mysqli_query($con,$idsql_cek);
            $row_coun=mysqli_num_rows($get_use_id_kingdom);
            echo "[Kingdom Default] Print Row td : ". $row['td'] ."<br>";
            echo "[Kingdom Default] Print SQL Cek : " .$idsql_cek . "<br>";
            echo "[Kingdom Default] Jumlah ROW : ". $row_coun . "<br>";
              if ($row_coun==1) {
                while ($rowid = mysqli_fetch_array($get_use_id_kingdom))
                {
                  $use_id_kingdom = $rowid['id_kingdom'];
        ...
        elseif ($row['th']=="Class"){
          ...
          echo "[Class] Jumlah ROW : ". $row_coun . "<br>";
            ...
            // $use_id_phylum=1;
            $idsql_cek="SELECT * FROM tb_phylum WHERE nama_phylum='tidak diketahui';";
            $get_use_id_phylum=mysqli_query($con,$idsql_cek);
            $row_coun=mysqli_num_rows($get_use_id_phylum);
            echo "[Phylum Default] Print Row td : ". $row['td'] ."<br>";
            echo "[Phylum Default] Print SQL Cek : " .$idsql_cek . "<br>";
            echo "[Phylum Default] Jumlah ROW : ". $row_coun . "<br>";
              if ($row_coun==1) {
                while ($rowid = mysqli_fetch_array($get_use_id_phylum))
                {
                  $use_id_phylum = $rowid['id_phylum'];
        ...
        elseif ($row['th']=="Order"){
          ...
          echo "[Ordo] Jumlah ROW : ". $row_coun . "<br>";
            ...
            // $use_id_class=1;
            $idsql_cek="SELECT * FROM tb_class WHERE nama_class='tidak diketahui';";
            $get_use_id_class=mysqli_query($con,$idsql_cek);
            $row_coun=mysqli_num_rows($get_use_id_class);
            echo "[Class Default] Print Row td : ". $row['td'] ."<br>";
            echo "[Class Default] Print SQL Cek : " .$idsql_cek . "<br>";
            echo "[Class Default] Jumlah ROW : ". $row_coun . "<br>";
              if ($row_coun==1) {
                while ($rowid = mysqli_fetch_array($get_use_id_class))
                {
                  $use_id_class = $rowid['id_class'];
        ...
        elseif ($row['th']=="Family"){
          ...
          echo "[Family] Jumlah ROW : ". $row_coun . "<br>";
            ...
            // $use_id_ordo=1;
            $idsql_cek="SELECT * FROM tb_ordo WHERE nama_ordo='tidak diketahui';";
            $get_use_id_ordo=mysqli_query($con,$idsql_cek);
            $row_coun=mysqli_num_rows($get_use_id_ordo);
            echo "[Ordo Default] Print Row td : ". $row['td'] ."<br>";
            echo "[Ordo Default] Print SQL Cek : " .$idsql_cek . "<br>";
            echo "[Ordo Default] Jumlah ROW : ". $row_coun . "<br>";
              if ($row_coun==1) {
                while ($rowid = mysqli_fetch_array($get_use_id_ordo))
                {
                  $use_id_ordo = $rowid['id_ordo'];
        ...
        elseif ($row['th']=="Genus"){
          ...
          echo "[Genus] Jumlah ROW : ". $row_coun . "<br>";
            ...
            // $use_id_family=1;
            $idsql_cek="SELECT * FROM tb_family WHERE nama_family='tidak diketahui';";
            $get_use_id_family=mysqli_query($con,$idsql_cek);
            $row_coun=mysqli_num_rows($get_use_id_family);
            echo "[Family Default] Print Row td : ". $row['td'] ."<br>";
            echo "[Family Default] Print SQL Cek : " .$idsql_cek . "<br>";
            echo "[Family Default] Jumlah ROW : ". $row_coun . "<br>";
              if ($row_coun==1) {
                while ($rowid = mysqli_fetch_array($get_use_id_family))
                {
                  $use_id_family = $rowid['id_family'];
        ...
        elseif ($row['th']=="Scientific Name" || $row['th']=="Species"){
          ...
          echo "[Species] Jumlah ROW : ". $row_coun . "<br>";
            ...
            // $use_id_genus=1;
            $idsql_cek="SELECT * FROM tb_genus WHERE nama_genus='tidak diketahui';";
            $get_use_id_genus=mysqli_query($con,$idsql_cek);
            $row_coun=mysqli_num_rows($get_use_id_genus);
            echo "[Genus Default] Print Row td : ". $row['td'] ."<br>";
            echo "[Genus Default] Print SQL Cek : " .$idsql_cek . "<br>";
            echo "[Genus Default] Jumlah ROW : ". $row_coun . "<br>";
              if ($row_coun==1) {
                while ($rowid = mysqli_fetch_array($get_use_id_genus))
                {
                  $use_id_genus = $rowid['id_genus'];
          ...
          elseif ($row['th']=="Group" || $row['th']=="Habitat" || $row['th']=="Diet" || $row['th']=="Prey" || $row['th']=="Predators" || $row['th']=="Lifestyle" || $row['th']=="Life Span"){
            ...
            echo "[Ciri] Jumlah ROW : ". $row_coun . "<br>";
              ...
              // $use_id_ciri=1;
              $idsql_cek="SELECT * FROM tb_ciri WHERE ciri='tidak diketahui';";
              $get_use_id_ciri=mysqli_query($con,$idsql_cek);
              $row_coun=mysqli_num_rows($get_use_id_ciri);
              echo "[Ciri Default] Print Row td : ". $row['td'] ."<br>";
              echo "[Ciri Default] Print SQL Cek : " .$idsql_cek . "<br>";
              echo "[Ciri Default] Jumlah ROW : ". $row_coun . "<br>";
                if ($row_coun==1) {
                  while ($rowid = mysqli_fetch_array($get_use_id_ciri))
                  {
                    $use_id_ciri = $rowid['id_ciri'];
          ...
          elseif ($row['th']=="Image"){
            ...
            echo "[Image Species] Jumlah ROW : ". $row_coun . "<br>";
              ...
              // $use_id_species=1;
              $idsql_cek="SELECT * FROM tb_species WHERE nama_species='tidak diketahui';";
              $get_use_id_species=mysqli_query($con,$idsql_cek);
              $row_coun=mysqli_num_rows($get_use_id_species);
              echo "[Species Default] Print Row td : ". $row['td'] ."<br>";
              echo "[Species Default] Print SQL Cek : " .$idsql_cek . "<br>";
              echo "[Species Default] Jumlah ROW : ". $row_coun . "<br>";
                if ($row_coun==1) {
                  while ($rowid = mysqli_fetch_array($get_use_id_species))
                  {
                    $use_id_species = $rowid['id_species'];
