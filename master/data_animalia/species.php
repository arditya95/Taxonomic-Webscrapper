...
<div class="panel panel-primary">
  ...
  <div class="panel-body">
    <a href="..\action\insert\species.php" class="btn btn-primary" role="button"><i class="fa fa-plus-circle" aria-hidden="true"></i>
  Tambah Data</a>
            ...
            <?php
              ...
              while ($row = mysqli_fetch_array($result))
              {
                ...
                <tr>
                   ...
                   <a href='..\action\update\species.php?id=$row[id_species]'>
                   <i class='fa fa-pencil-square-o' aria-hidden='true'></i>Edit</a> |
                   <a href='..\action\delete\delete_species.php?id=$row[id_species]'>
