          ...
          <div class="panel panel-primary">
            <div class="panel-heading">
              <?php
                ...
                $sql=("SELECT * FROM tb_ciri_genus
                       INNER JOIN tb_genus
                       ON tb_ciri_genus.`id_genus`=tb_genus.`id_genus`
                       WHERE tb_ciri_genus.`id_genus` = '$_GET[idt]' AND id_ciri = '$_GET[idc]'");
                $result = mysqli_query($con,$sql);
                $baris=mysqli_fetch_array($result);
              ?>
              <label>Edit Ciri Genus <?php echo $baris['nama_genus'];?></label>
            </div>
            <div class="panel-body">
              <form class="form-horizontal" action="update_c_genus.php" method="post">
                <div class="container-fluid">
                  <div class="form-group">
                    <input type="hidden" class="form-control" name="idt" value="<?php echo $baris['id_genus'];?>">
                    <input type="hidden" class="form-control" name="idc" value="<?php echo $baris['id_ciri'];?>">
                    <label for="taxon">Genus</label>
                    <?php
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control" name="deskripsi" rows="8" cols="80"><?php echo $baris['keterangan_cgenus'];?></textarea>
                  </div>
                  <div class="form-group">
