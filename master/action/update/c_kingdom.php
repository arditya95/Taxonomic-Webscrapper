              ...
              <form class="form-horizontal" action="update_c_kingdom.php" method="post">
                <div class="container-fluid">
                  <div class="form-group">
                    <input type="hidden" class="form-control" name="idt" value="<?php echo $baris['id_kingdom'];?>">
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control" name="deskripsi" rows="8" cols="80"><?php echo $baris['keterangan_ckingdom'];?></textarea>
                  </div>
                  <div class="form-group">
