        ...
        <div class="col-md-6">
          <div class="panel panel-primary">
            <div class="panel-heading">
              <label>Tambah Ciri Species</label>
            </div>
            <div class="panel-body">
              <form class="form-horizontal" action="insert_c_species.php" method="post">
                <div class="container-fluid">
                  <div class="form-group">
                    ...
                    <?php
                      ...
                      $select.='<option selected="selected" value="0">Pilih Species</option>';
